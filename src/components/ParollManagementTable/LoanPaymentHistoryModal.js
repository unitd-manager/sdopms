...
function LoanPaymentHistoryModal({loanPaymentHistoryModal,setLoanPaymentHistoryModal,loanHistories}) {
  ...
  return (
                    ...
                    loanHistories.map((element) => {
                      return (
                        <tr key={element.loan_id}>
                          ...
                          <td>{element.loan_start_date? moment(element.loan_start_date).format('YYYY-MM-DD'):''}</td>
                          <td>{element.amount}</td>
                          <td>{element.month_amount}</td>
                          <td>{element.loan_closing_date? moment(element.loan_closing_date).format('YYYY-MM-DD'):''}</td>
                        </tr>
                      );
                    })}
    ...
    <ModalFooter>
        ...
        <Button color="dark" className='shadow-none' onClick={()=>{setLoanPaymentHistoryModal(false)}}> Close </Button>
    </ModalFooter>
</Modal> 
</>
  )
