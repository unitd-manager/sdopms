...
export default function ProjectCompanyDetails({
  handleInputProject,
  allCountries,
  insertCompanyProject,
  modal,
  toggle,
}) {
  ProjectCompanyDetails.propTypes = {
    handleInputProject: PropTypes.any,
    insertCompanyProject: PropTypes.any,
                    ...
                    <Row>
                      <Col md="4">
                        <FormGroup>
                          ...
                          <Input type="text" name="company_name" onChange={handleInputProject} />
                        </FormGroup>
                      </Col>
                      <Col md="4">
                        <FormGroup>
                          <Label>Website</Label>
                          <Input type="text" name="website" onChange={handleInputProject} />
                        </FormGroup>
                      </Col>
                      <Col md="4">
                        <FormGroup>
                          ...
                          <Input type="text" name="phone" onChange={handleInputProject} />
                        </FormGroup>
                      </Col>
                      <Col md="4">
                        <FormGroup>
                          <Label>Main Fax</Label>
                          <Input type="text" name="fax" onChange={handleInputProject} />
                        </FormGroup>
                      </Col>
                    </Row>
                  </Form>
                  ...
                  <Row>
                    ...
                    <Col md="4">
                      <FormGroup>
                        ...
                        <Input type="select" name="address_country" onChange={handleInputProject}>
                  ...
                  <Row>
                    <Col md="4">
                      <FormGroup>
                        ...
                        <Input type="select" name="supplier_type" onChange={handleInputProject}>
                    ...
                    <Col md="4">
                      <FormGroup>
                        ...
                        <Input type="select" name="industry" onChange={handleInputProject}>
                          <option defaultValue="selected">Please Select</option>
                    ...
                    <Col md="4">
                      <FormGroup>
                        ...
                        <Input type="select" name="company_size" onChange={handleInputProject}>
                          <option defaultValue="selected">Please Select</option>
                    ...
                    <Col md="4">
                      <FormGroup>
                        ...
                        <Input type="select" name="source" onChange={handleInputProject}>
                          <option defaultValue="selected">Please Select</option>
