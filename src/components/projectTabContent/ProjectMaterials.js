...
const AddPoModal = ({
  projectId,
  supplierId,
  addModalProjectMaterial,
  setAddModalProjectMaterial,
  //PurchaseOrderId,
}) => {
  AddPoModal.propTypes = {
    addModalProjectMaterial: PropTypes.bool,
    projectId: PropTypes.string,
    supplierId: PropTypes.any,
    //PurchaseOrderId: PropTypes.any,
    setAddModalProjectMaterial: PropTypes.func,
  };
  const [addNewProductModal, setAddNewProductModal] = useState(false);
   ...
   console.log(shipToYard)
   console.log(movedToShip)
...
const getStockLogs = () => {
  api.post('/projecttabmaterialusedportal/getstockExchangeLogsByProjectId',{project_id:projectId}).then((res) => {
...
const insertProduct = (ProductCode, ItemCode) => {
  ...
  const poProduct = (itemObj) => {
    ...
    .catch(() => {
      ...
      .catch(() => {
        message('Unable to move stock', 'error');
      });
  };
  ...
  return (
    ...
    <Col md="2">
                    <Button
                      ...
                      onClick={() => {
                        setAddModalProjectMaterial(true);
                      }}
                    >
                      Move Stock
                    </Button>
                  ...
                  {/* <Col md="4">
                    <span>Stocks in ship:{shipStock}</span>
                  </Col> */}
                  </Row>
                  <Row>
      ...
      <Modal size="xl" isOpen={addModalProjectMaterial}>
...
{/* 
        ...
        <ModalFooter>
          ...
          <Button
            ...
            className="shadow-none"
            onClick={() => {
              setAddModalProjectMaterial(false);
            }}
          >
            Cancel
          </Button>
