    ...
    <div>
          ...
          <Col md="3">
                    ...
                    <Col md="3">
                        <FormGroup>
                        <Label>Country</Label>
                        <Input name="address_country1" value={contactInformationDetails && contactInformationDetails.address_country1} onChange={handleCiInputs} type="text" disabled/>
                        </FormGroup>
                    </Col>
                </Row>
                <Row>
          ...
          <Row>
                    ...
                    <Col md="3">
                        <FormGroup>
                        <Label>Country</Label>
                        <Input name="foreign_addrs_country" value={contactInformationDetails && contactInformationDetails.foreign_addrs_country} onChange={handleCiInputs} type="text" disabled/>
                        </FormGroup>
                    </Col>
                </Row>
                <Row>
