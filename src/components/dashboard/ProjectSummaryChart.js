        ...
        <Col>
          <ComponentCard title="Project Summary">
            ...
            >
              ...
              {project &&
                project.map((element) => {
                  return <option key={element.project_id} value={element.project_id}>{element.title}</option>;
                })}
            </Input>
            <CardBody>
              {data &&
                    ...
                    <Row key={ele.project_id}>
                      <Col md="6">
                        <Row>
                          <Label>
                            {' '}
                            <b>Project code: </b> <Link to={`/projectEdit/${ele.project_id}`}> {ele.project_code} </Link>{' '}
                          </Label>
                          <Label>
                            {' '}
