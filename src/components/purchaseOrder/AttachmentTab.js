...
function AttachmentTab({dataForPicture,
    dataForAttachment,
    setAttachmentModal,
    id,
    attachmentModal,
  ...
  return (
    ...
    <FormGroup>
      <ComponentCard title="Picture">
        ...
        />
        <ViewFileComponentV2 moduleId={id} roomName="PurchaseorderPic" recordType="Picture" />
      </ComponentCard>
    </FormGroup>
  </Form>
  </Col>
  ...
  <Form>
    <FormGroup>
      <ComponentCard title="Attachments">
        ...
        />
        <ViewFileComponentV2 moduleId={id} roomName="PurchaseorderAttachment" recordType="RelatedPicture" />
      </ComponentCard>
    </FormGroup>
  </Form>
  </Col> 
