...
const insertTender = () => {
  ...
  return (
    <div>
            ...
            <Form>
              ...
              <FormGroup>
                ...
                <Label>Add New Name</Label>
                    <Button color="primary" className='shadow-none' onClick={toggle.bind(null)}>Add New</Button>
                </Col>
                </Row>
              </FormGroup>
              <FormGroup>
              ...
              <Row>
                ...
                <Col md="12">
                  <FormGroup>
                    ...
                    <Input type="text" name="address_town" placeholder=""  onChange={handleInputs}
                      />
                  </FormGroup>
                </Col>
                <Col md="6">
      ...
      <ModalFooter>
        <Button color="primary" className='btn mr-2 shadow-none'  onClick={()=>{
          insertCompany()
        }} >
          Save & Continue
        </Button>
